...
public class GroupBuyActivity extends PageTabActivity {
	...
	public Fragment[] getFragment() {
		...
		fragments[0] = GroupBuyFragment.instance(null);
		fragments[1] = GroupBuyFragment.instance("normal");
		fragments[2] = GroupBuyFragment.instance("good ");
		fragments[3] = GroupBuyFragment.instance("bad");
		return fragments;
	}
