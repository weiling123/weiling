...
public class MoreShopBean implements Serializable {
	...
	private String goodCommentTotalCount;
	private String isMultiSpecEnabled;
	private String normalCommentTotalCount;
	private String isCollected;
	private String commentTotalCount;
	private List<String> appSpecVoList;
	private String badCommentTotalCount;
	...
	public String getGoodCommentTotalCount() {
		return goodCommentTotalCount;
	}

	public void setGoodCommentTotalCount(String goodCommentTotalCount) {
	...
	public String getNormalCommentTotalCount() {
		return normalCommentTotalCount;
	}

	public void setNormalCommentTotalCount(String normalCommentTotalCount) {
	...
	public void setCommentTotalCount(String commentTotalCount) {
		this.commentTotalCount = commentTotalCount;
	}

	public List<String> getAppSpecVoList() {
		return appSpecVoList;
	}

	public void setAppSpecVoList(List<String> appSpecVoList) {
		this.appSpecVoList = appSpecVoList;
	}

	public String getBadCommentTotalCount() {
		return badCommentTotalCount;
	}

	public void setBadCommentTotalCount(String badCommentTotalCount) {
	...
	public void setAppSkuVos(List<appSkuVos> appSkuVos) {
		this.appSkuVos = appSkuVos;
	}
