...
public class CommonAlertDialog {
	 ...
	 *            取消按钮的监听器
	 */
	public void showYesOrNoDialog(String resMsg, OnClickListener positiveListener, OnClickListener negativeListener) {
		...
		TextView mTextViewMsg = (TextView) diaView.findViewById(R.id.dialog_msg);
	...
	public void showYesDialog(String resMsg, OnClickListener positiveListener) {
		...
		Button mCancelButton = (Button) diaView.findViewById(R.id.btn_cancel);
		mCancelButton.setVisibility(View.GONE);
		View view_match = (View) diaView.findViewById(R.id.view_match);
