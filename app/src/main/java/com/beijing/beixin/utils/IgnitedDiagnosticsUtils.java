...
public class IgnitedDiagnosticsUtils {
	...
	public static final boolean SUPPORTS_ICS, SUPPORTS_HONEYCOMB, SUPPORTS_GINGERBREAD, SUPPORTS_FROYO, SUPPORTS_ECLAIR,
	...
	/**
	 * 读取安卓id Returns the ANDROID_ID unique device ID for the current device.
	 * Reading that ID has changed between platform versions, so this method
	 * takes care of attempting to read it in different ways, if one failed.
	 *
	 * @param context
	 *            the context
	...
	/**
	 * Same as {@link #getAndroidId(android.content.Context)}, but never returns
	 * null.
	 *
	 * @param context
	 *            the context
